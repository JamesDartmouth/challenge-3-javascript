...
function generatePassword() {
    ...
    //   working on code to make sure at least one charcter from preferred array (upper, lower, number, special) is in generated password
    // var passcheck = password.split('')
    // if (upperPrefer === true){
    //   passheck [0||1,2,3,4,5,6,7] = upperCase['']
    
    //     if (upperPrefer === true) {
    //         [password]=arr.upperCase
    //     }
